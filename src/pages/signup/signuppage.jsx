        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <motion.div 
              ...
              className="w-full max-w-md mx-auto lg:max-w-none order-2 lg:order-1"
            >
              <div className="relative bg-white/80 backdrop-blur-sm rounded-3xl border border-gray-200 shadow-2xl shadow-gray-100/50 p-8 md:p-10 overflow-hidden">
                ...
                <div className="mb-8">
                  ...
                  <p className="text-gray-500 text-sm">Join GymCrab and start your fitness journey today.</p>
                </div>
            ...
            >
              ...
              <p className="text-gray-500 text-lg leading-relaxed mb-10 max-w-md">
                 Register now to manage your gym, track member progress, and grow your fitness business efficiently.
              </p>

              {/* Visual Decorations */}
              <div className="relative h-64">
                <motion.div 
                  className="absolute right-0 w-64 h-64 border-2 border-emerald-100 rounded-3xl"
                  animate={{ rotate: 360 }}
                  transition={{ duration: 30, repeat: Infinity, ease: "linear" }}
                />
                <motion.div 
                  className="absolute left-5 top-5 w-48 h-48 bg-green-50 rounded-2xl shadow-xl flex items-center justify-center"
                  animate={{ y: [0, -10, 0] }}
                  transition={{ duration: 4, repeat: Infinity }}
                >
                   <div className="text-center">
                     <div className="text-4xl mb-2">🚀</div>
                     <span className="text-xs font-bold text-green-700 uppercase tracking-wider">Quick Setup</span>
                   </div>
                </motion.div>
                 <motion.div 
                  className="absolute bottom-0 right-10 w-32 h-32 bg-emerald-50 rounded-2xl shadow-xl flex items-center justify-center"
                  animate={{ y: [0, 10, 0] }}
